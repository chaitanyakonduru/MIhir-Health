...
public class MyAccountActivity extends Activity implements OnClickListener,
	...
	private String getUserName() {
		...
		if (currentUser instanceof Doctor) {
			...
			username = doctor.getmDoctor_Name();
		} else if (currentUser instanceof PatientResponse) {
			PatientResponse patientResponse = (PatientResponse) currentUser;
			username = patientResponse.getPatient().getmPatient_Name();
		} else if (currentUser instanceof MMSStaff) {
			MMSStaff mmsStaff = (MMSStaff) currentUser;
			username = mmsStaff.getmStaff_Name();
		} else if (currentUser instanceof HospitalStaff) {
			HospitalStaff hospitalStaff = (HospitalStaff) currentUser;
			username = hospitalStaff.getmHospital_Staff_Name();
		}
